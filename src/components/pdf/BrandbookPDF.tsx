...
const VOICE_MAP: Record<string, string> = {
  A: "O Negociador Implacável (Dados e ROI)",
  B: "O Estrategista Frio (Ação e Escassez)",
  C: "O Patriarca Fiel (Legado e Confiança)"
};

interface BrandbookPDFProps {
  clientName: string;
  aiInsight?: string;
  tilt: { technical: number, culture: number, lifestyle: number };
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        {/* ZONA 1: CONTENT TILT */}
        <View wrap={false}>
          <Text style={styles.sectionTitle}>1. Alocação de Tilt (Energia)</Text>
          
          <View style={styles.tiltContainer}>
            <Text style={styles.tiltLabel}>Autoridade Técnica</Text>
            <View style={styles.tiltBarBg}><View style={[styles.tiltBarFill, { width: `${tilt.technical}%` }]} /></View>
            <Text style={styles.tiltValue}>{tilt.technical}%</Text>
          </View>
          
          <View style={styles.tiltContainer}>
            <Text style={styles.tiltLabel}>Cultura e Bastidores</Text>
            <View style={styles.tiltBarBg}><View style={[styles.tiltBarFill, { width: `${tilt.culture}%` }]} /></View>
            <Text style={styles.tiltValue}>{tilt.culture}%</Text>
          </View>
          
          <View style={styles.tiltContainer}>
            <Text style={styles.tiltLabel}>Lifestyle e Status</Text>
            <View style={styles.tiltBarBg}><View style={[styles.tiltBarFill, { width: `${tilt.lifestyle}%` }]} /></View>
            <Text style={styles.tiltValue}>{tilt.lifestyle}%</Text>
          </View>
        </View>
        ...
        <View wrap={false}>
          ...
          <View style={styles.dataGrid}>
            ...
            <View style={styles.dataCard}>
              <Text style={styles.dataCardLabel}>O Estado Humano</Text>
              <Text style={styles.dataCardValue}>
            ...
            <View style={styles.dataCard}>
              <Text style={styles.dataCardLabel}>Reação Sob Pressão (Voz)</Text>
              <Text style={styles.dataCardValue}>
                {voice.price_objection ? VOICE_MAP[voice.price_objection] : 'Pendente'}
              </Text>
            </View>
          </View>
        </View>
